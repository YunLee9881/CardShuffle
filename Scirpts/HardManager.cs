...
public class HardManager : MonoBehaviour
{
    ...
    void addACard(int row, int rank, int value)
    {
        ...
        GameObject.Find("" + row + "_" + value).GetComponent<HardTile>().setOriginalSprite(s1);
    }
            ...
            if (timer > 0.7)
            {
                ...
                timeHasStarted = false;
                    ...
                    else
                    {
                        ...
                        card1.GetComponent<HardTile>().hideCard();
                        card2.GetComponent<HardTile>().hideCard();
                    }
    ...
    public void cardSelected(GameObject card)
    {
        ...
        if (!firstCardSelected)
        {
            ...
            card1 = card;
            card1.GetComponent<HardTile>().revealCard();
        ...
        else if (firstCardSelected && !secondCardSelected)
        {
            ...
            if (rowForCard2 != rowForCard1)
            {
                ...
                card2 = card;
                card2.GetComponent<HardTile>().revealCard();
                checkCards();
            }
        }
    }
